...
Loudness, true peak, and start timecode are not checked by the shipped VOD profile because they are often missing from Iconik metadata exports. Start timecode remains available in Settings and can be checked back on for any custom profile.
...
Loudness and true peak are available only as optional profile checks. This lite app does not measure audio directly from the media.
