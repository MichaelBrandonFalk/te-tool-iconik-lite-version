(function () {
  ...
  function exportCsv() {
    download("te_tool_iconik_lite_results_v1_10.csv", TeIconikLite.toCsv(state.results), "text/csv");
  }

  function exportJson() {
    download("te_tool_iconik_lite_results_v1_10.json", JSON.stringify(state.results, null, 2), "application/json");
  }
